...
export default function QuizInterface ({ questionSet = [], sectionId, testSubmissionId }) {
  ...
  return (
    <div className='flex flex-col h-[calc(100vh-70px)] lg:flex-row font-sans bg-white text-gray-800'>
      {/* Left: Question Area */}
      <div className='flex-1 flex h-full justify-start p-10'>
      ...
      {/* Right: Navigator */}
      <div className='w-full h-full lg:w-1/4 border-t lg:border-t-0 lg:border-l border-gray-200 p-6 bg-gray-50 flex flex-col justify-between'>
        <div>
