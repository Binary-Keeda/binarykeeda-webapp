    ...
    return (
      <>
        <header className="relative h-[70px]">
          <nav
            className={`fixed shadow-sm dark:text-gray-50 bg-blend-difference text-gray-600  h-[70px] items-center pr-5 pl-2  flex justify-between z-40 w-full top-0 dark:bg-[${DARK_STRONG}] bg-white`}
          >
