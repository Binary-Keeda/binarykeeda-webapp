...
export default function Hero() {
    ...
    return (
        <section id="home" className="relative h-[calc(100vh-80px)] w-full overflow-hidden" >
            ...
            <div className="flex flex-col md:flex-row h-full items-center justify-center px-6 md:px-36 relative z-10 gap-8 md:gap-0 ">
                {/* Hero Image - Shows first on mobile */}
                <div className="flex justify-center md:justify-start order-1 md:order-2 md:flex-1">
                ...
                <div className="flex flex-col justify-center text-center md:text-left order-2 md:order-1 md:flex-1">
                    ...
                    <div className="mt-6 md:mt-8 flex gap-4 items-center md:items-start">
